    ...
    private List<String> mergeSplits(List<String> splits, String separator) {
        ...
        for (String split : splits) {
            ...
            if (currentLength + len > maxSize && currentLength > 0) {
                ...
                // Простая реализация overlap: начинаем новый чанк с текущего сплита
                // Для полноценного overlap (как в LangChain) требуется сложный буфер,
                // но для базы этот вариант работает отлично.
