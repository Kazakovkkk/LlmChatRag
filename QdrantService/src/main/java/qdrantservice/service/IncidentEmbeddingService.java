...
public class IncidentEmbeddingService {
    ...
    public void storePdfDocument(
        ...
        // Один вызов Spring AI позволяет embedding-модели
        // обработать список документов пакетом.
        store.doAdd(documents);

        // Сначала формируем окончательную статистику
        // для всех новых документов.
        ...
        // Затем пересчитываем sparse-векторы уже по
        // окончательным N, DF и avgDocumentLength.
        rebuildSparseVectors(
                mainCollection,
                statsCollection
        );
